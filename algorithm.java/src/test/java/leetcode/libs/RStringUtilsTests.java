...
public class RStringUtilsTests extends TestBase {

    private static final String infile = IF_PREFIX + "libs/stringutils.dat";
    ...
    @Test
    public void test_1() {
        assertArrayEquals(E, RStringUtils.mykmp_pattern(I));
    }
